...
def calc_score(round):
    ...
    # Outcome logic table can be seen here: https://i.imgur.com/IlMPnB9.png
    outcome_score_arr = np.array(([3,0,6], [6,3,0], [0,6,3]))
    
    shape_score = outcome_table[round[1]]
    outcome_score = outcome_score_arr[outcome_table[round[1]] - 1, shape_table[round[0]] - 1]
